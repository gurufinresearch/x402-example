...
func main() {
	...
	// Must match server [X402_NETWORK] (default cevm:9001).
	...
	// Create x402 client and register cevm scheme for the same CAIP-2 network as the resource server.
	client := x402.Newx402Client()
	client.Register(x402.Network(x402Network), cevm.NewExactCevmScheme(cevmSigner))
